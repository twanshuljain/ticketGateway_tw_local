...
extension BandLeaderProfileViewController {
    func setCollectionView() {
        ...
        self.collectionView.register(
            UINib(nibName: "OtherBrandLeaderCollectionViewCell", bundle: nil),
            forCellWithReuseIdentifier: "OtherBrandLeaderCollectionViewCell"
        )
    }
    func configureTableView() {
        ...
        self.tblView.register(UINib(nibName: "CostumeTableViewCell", bundle: nil),
                              forCellReuseIdentifier: "CostumeTableViewCell")
        self.tblView.register(UINib(nibName: "DescriptionTableViewCell", bundle: nil),
                              forCellReuseIdentifier: "DescriptionTableViewCell")
        self.tblView.register(UINib(nibName: "LeaderProfileTableViewCell", bundle: nil),
                              forCellReuseIdentifier: "LeaderProfileTableViewCell")
        self.tblView.register(UINib(nibName: "ContactDetailsTableViewCell", bundle: nil),
    ...
    func setUpUI() {
        ...
        self.segmentControl.setTitleTextAttributes(
            [.foregroundColor: UIColor.setColor(colorType: .white)],
            for: .selected
        )
        self.segmentControl.setTitleTextAttributes(
            [.foregroundColor: UIColor.setColor(colorType: .segmentColor)], for: .normal
        )
    }
}
// MARK: - Actions
extension BandLeaderProfileViewController {
    @IBAction private func actionSegmentControl(_ sender: Any) {
        ...
        case 0:
            self.segmentControl.setTitleTextAttributes(
                [.font: UIFont.setFont(fontType: .regular, fontSize: .twelve)],
                for: .normal
            )
            self.segmentControl.setTitleTextAttributes(
                [.font: UIFont.setFont(fontType: .regular, fontSize: .twelve)],
            ...
            self.segmentControl.setTitleTextAttributes(
                [.foregroundColor: UIColor.setColor(colorType: .segmentColor)],
                for: .normal
            )
            self.segmentControl.setTitleTextAttributes(
                [.foregroundColor: UIColor.setColor(colorType: .white)],
        ...
        case 1:
            ...
            self.segmentControl.setTitleTextAttributes(
                [.font: UIFont.setFont(fontType: .regular,
                                       fontSize: .twelve)],
                for: .selected
            )
            self.segmentControl.setTitleTextAttributes(
    ...
    func tableView(_ tableView: UITableView,
        ...
        if !viewModel.isAboutSelected {
            if let cell = tableView.dequeueReusableCell(
                withIdentifier: "CostumeTableViewCell",
                for: indexPath
            ) as? CostumeTableViewCell {
            ...
            case 1:
                if let cell = tableView.dequeueReusableCell(
                    withIdentifier: "LeaderProfileTableViewCell",
                    for: indexPath
                ) as? LeaderProfileTableViewCell {
                    cell.selectionStyle = .none
            ...
            case 2:
                if let cell = tableView.dequeueReusableCell(
                    withIdentifier: "ContactDetailsTableViewCell",
                    for: indexPath
                ) as? ContactDetailsTableViewCell {
                    cell.selectionStyle = .none
                    return cell
                }
            default:
...
// MARK: - NavigationBarViewDelegate
extension BandLeaderProfileViewController: UICollectionViewDelegate, UICollectionViewDataSource,
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        if let cell = collectionView.dequeueReusableCell(
            withReuseIdentifier: "OtherBrandLeaderCollectionViewCell",
            for: indexPath
        ) as? OtherBrandLeaderCollectionViewCell {
...
extension BandLeaderProfileViewController {
    func toSetPageControll() {
        imagePageController.drawer = ExtendedDotDrawer(
            numberOfPages: self.viewModel.arrBrandLeader.count,
            space: 16.0,
