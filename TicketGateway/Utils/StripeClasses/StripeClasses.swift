...
class StripeClasses: NSObject {
    ...
    func createCheckout(eventId: Int?, orderType:String?, totalUserLoyaltyPoint: String?, totalUserSpentAmount:String?, ticketIDs: [CheckoutTicketID]?, addOnList: [CheckoutAddonList]?, controller:UIViewController?, complition: @escaping (CheckoutId?,Bool,String) -> Void ) {
